...
<style type="text/css">
 input#bandguide4 {
background:url(/cafeService/resources/img/guide4.jpg);
...
<div class="container" >
<form   action ="./bandmain" align="CENTER">
<input type="submit"  id="bandguide4" name="bandguide4" value="" >
</form></div>
