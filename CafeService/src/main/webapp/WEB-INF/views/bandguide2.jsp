...
<style type="text/css">
 input#bandguide2 {
background:url(/cafeService/resources/img/guide2.jpg);
...
<div class="container" >
<form   action ="./bandguide3" align="CENTER">
<input type="submit"  id="bandguide2" name="bandguide2" value="" >
</form></div>
